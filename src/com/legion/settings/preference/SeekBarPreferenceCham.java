...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String LEGIONNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, LEGIONNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, LEGIONNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(LEGIONNS, "interval");
            if(newInterval != null)
